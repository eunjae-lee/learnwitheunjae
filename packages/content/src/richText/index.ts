// https://github.com/storyblok/storyblok-js-client/blob/8c23a7d6a51d0c9dbe82055e9b443eb30bc451ed/src/richTextResolver.ts

import defaultHtmlSerializer from "./schema";
import type { ISbSchema, ISbRichtext } from "./interfaces";
